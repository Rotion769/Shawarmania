...
function Home({ count, setCount, secondcount, setsecondCount, thirdcount, setthirdCount }) {
  ...
  return (
    <div className="bg-gray-50">
      ...
      <section ref={homeRef} id="home" className="bg-cover bg-center h-screen flex items-center justify-center px-4" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1665989215795-f67f4723087d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 md:p-6 hover:scale-105 transition-transform duration-300">
              <img src="https://pngimg.com/d/shawarma_PNG30.png" alt="Chicken Shawarma" className="w-full object-cover rounded-md" />
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 md:p-6 hover:scale-105 transition-transform duration-300">
              <img src="https://static.vecteezy.com/system/resources/previews/036/627/312/non_2x/ai-generated-savory-beef-shawarma-on-transparent-background-png.png" alt="Beef Shawarma" className="w-full object-cover rounded-md " />
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 md:p-6 hover:scale-105 transition-transform duration-300">
              <img src="https://pngimg.com/d/shawarma_PNG51.png" alt="Veggie Shawarma" className="w-full object-cover rounded-md" />
...
>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <section ref={locationRef} id="location" className="py-20 bg-gray-200">
        <div className="container mx-auto text-center">
          ...
          <p className="text-gray-600 mb-6 px-4">Shawarmania - PES University Address: Right outside BE Block, PES University, 100 Feet Ring Road, Banashankari Stage III, Bangalore
          </p>
          <iframe
  ...
  className="w-full h-64 md:h-96 lg:h-[450px] rounded-lg shadow-lg px-4"
  allowFullScreen
  loading="lazy"
